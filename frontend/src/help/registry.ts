...
export const HELP_METRICS: Record<string, HelpEntry> = {
  ...
  portfolio_candidate: {
    ...
    summary: "Исследовательский ответ: что Kraken сделал бы с капиталом сейчас.",
    details:
      "Не приказ брокеру. Собирает allocation, Risk Gate и целые лоты в один экран.",
  },
  target_allocation: {
...
export const HELP_PAGES: Record<string, PageHelpContent> = {
  ...
  portfolio_candidate: {
    ...
    about:
      "Один экран: что Kraken сделал бы с капиталом сейчас, какие позиции и лоты, что отклонено и почему.",
    understand: [
      "Что такое кандидат портфеля?",
      "Почему это ещё не инструкция к реальной покупке?",
      "Как Kraken выбирает инструменты?",
      "Почему некоторые позиции отклонены?",
      "Почему остаются деньги?",
      "Почему фактические веса отличаются?",
      "Что значит confidence?",
    ...
    interpret: [
      "Сначала смотрите hero: капитал, доли, статус.",
      "Потом позиции и «Что не включил».",
      "Technical details — только если нужны версии и provenance.",
    ],
    limitations: [
      "Нет брокера и real money.",
      "Налоги не моделируются.",
