            ...
            <>
              ...
              {isRankingCandidate ? (
                <p className="field-hint" data-testid="ranking-candidate-help">
                  Эта модель не пытается точно предсказать процент будущей доходности. Она оценивает
                  относительную привлекательность инструментов на одну дату. Чем выше рейтинговый балл,
                  тем выше инструмент в текущем рейтинге. Баллы разных моделей напрямую между собой не
                  сравниваются. <MetricHelp metricId="ranking_model" />
                </p>
              ) : null}
            </>
          ) : null}
