...
| 6 | Trading Policy + Risk + Portfolio simulation | **Policy/Risk Research V1** PROMISING on DEVELOPMENT_OOS (hysteresis). **Forward Signal V0** accumulates immutable FORWARD_LIVE predictions from activation. Shadow Portfolio **next**. No real broker |
