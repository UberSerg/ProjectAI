...
**Explicitly not implemented:** Deep History H4B total return / dividends, H5 versioned
recompute, Dataset v2. **H4A** mechanical-adjusted Analytics (`basic_daily` v2) is
...
| 2 | **Deep History H0–H6** | **H0–H3 RAW + H4A mechanical Analytics v2.** Not ML-ready. H4B TR / H3.1 DIVIDEND / H5+ not started |
