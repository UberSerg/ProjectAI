...
from __future__ import annotationsfrom pathlib import Pathfrom app.core.config import get_settings# Default OFF. Identity/events update is separate from FNS RAS sync.
...
PROVIDER_FNS_GIR_BO = "FNS_GIR_BO"
...
FNS_ARTIFACT_DIR = Path(".tmp/public-fundamentals-dividends-foundation-v1")
...
def fns_fundamentals_sync_enabled() -> bool:
    return bool(getattr(get_settings(), "fns_fundamentals_sync_enabled", False))
